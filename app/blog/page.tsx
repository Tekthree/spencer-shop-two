...
export default async function BlogIndexPage() {
  ...
  return (
    <div className="bg-[#F6F4F0]">
      {/* Header */}
      <div className="px-4 md:px-6 pt-10 md:pt-20 pb-8 md:pb-10 border-b border-[#020312]/10">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-10 md:py-24 space-y-16 md:space-y-24">
