              ...
              {collections.map((collection) => (
                <tr key={collection.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link href={`/admin/collections/${collection.id}`} className="text-black hover:text-gray-600 mr-4">
                      Edit
                    </Link>
                    <Link href={`/collections/${collection.id}`} target="_blank" className="text-gray-600 hover:text-black">
                      View
                    </Link>
                  </td>
                </tr>
